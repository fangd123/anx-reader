...
class ChatOpenAIOptions extends ChatModelOptions {
  ...
  const ChatOpenAIOptions({
    ...
    this.deepSeekThinking,
    this.includeReasoningContentInAssistantMessages = false,
    this.metadata,
  ...
  /// **DeepSeek only.** Reasoning effort values including `max`.
  final ChatOpenAIDeepSeekReasoningEffort? deepSeekReasoningEffort;

  /// **DeepSeek only.** Thinking mode configuration for `deepseek-v4-pro`.
  final ChatOpenAIDeepSeekThinking? deepSeekThinking;

  /// Whether assistant messages should serialize `reasoning_content`
  /// when replaying tool rounds back to the API.
  final bool includeReasoningContentInAssistantMessages;
  ...
  ChatOpenAIOptions copyWith({
    ...
    return ChatOpenAIOptions(
      ...
      includeReasoningContentInAssistantMessages:
          includeReasoningContentInAssistantMessages ??
              this.includeReasoningContentInAssistantMessages,
  ...
  ChatOpenAIOptions merge(covariant final ChatOpenAIOptions? other) {
    return copyWith(
      ...
      deepSeekReasoningEffort: other?.deepSeekReasoningEffort,
      deepSeekThinking: other?.deepSeekThinking,
      includeReasoningContentInAssistantMessages:
          other?.includeReasoningContentInAssistantMessages,
  ...
  int get hashCode {
    return model.hashCode ^
        ...
        deepSeekReasoningEffort.hashCode ^
        deepSeekThinking.hashCode ^
        includeReasoningContentInAssistantMessages.hashCode ^
...
/// DeepSeek reasoning effort values.
enum ChatOpenAIDeepSeekReasoningEffort { low, medium, high, max }

/// DeepSeek thinking mode configuration.
@immutable
class ChatOpenAIDeepSeekThinking {
  const ChatOpenAIDeepSeekThinking._({
    required this.type,
  });

  const ChatOpenAIDeepSeekThinking.enabled()
      : this._(type: 'enabled');
  ...
  @override
  bool operator ==(covariant ChatOpenAIDeepSeekThinking other) {
    return identical(this, other) || type == other.type;
  }
