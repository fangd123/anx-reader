...
class DeepSeekThinking {
  ...
  @override
  bool operator ==(covariant DeepSeekThinking other) {
...
class ChatCompletionCreateRequest {
  ...
  factory ChatCompletionCreateRequest.fromJson(Map<String, dynamic> json) {
    return ChatCompletionCreateRequest(
      ...
      reasoningEffort: json['reasoning_effort'] != null
          ...
          : null,
      deepSeekThinking: json['thinking'] != null
          ? DeepSeekThinking(
              type: (json['thinking'] as Map<String, dynamic>)['type']
                  as String,
            )
          : null,
  ...
  /// **DeepSeek only.** Thinking mode configuration.
  final DeepSeekThinking? deepSeekThinking;
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (deepSeekThinking != null) 'thinking': deepSeekThinking!.toJson(),
  ...
  ChatCompletionCreateRequest copyWith({
    ...
    Object? deepSeekThinking = unsetCopyWithValue,
    Object? includeReasoningContentInAssistantMessages = unsetCopyWithValue,
    ...
    return ChatCompletionCreateRequest(
      ...
      deepSeekThinking: deepSeekThinking == unsetCopyWithValue
          ? this.deepSeekThinking
          : deepSeekThinking as DeepSeekThinking?,
      includeReasoningContentInAssistantMessages:
          includeReasoningContentInAssistantMessages == unsetCopyWithValue
          ? this.includeReasoningContentInAssistantMessages
          : includeReasoningContentInAssistantMessages as bool,
